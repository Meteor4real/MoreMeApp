...
export const TRACKS: TrackDef[] = [
  ...
  // — eight more with distinct instrument palettes —
  { id: "sharled-eve",  name: "Sharled · Closing Bell",   vibe: "smooth jazz",      bpm: 88,  root: 49, scale: [0,2,3,5,7,9,10],  prog: [[0,2,4,6],[3,5,0,2],[1,3,5,0],[4,6,1,3]], lead: "triangle", pad: "sine",     leadDensity: 0.25, drums: "soft",                                                      color: "#eab308" },
  { id: "halos-dawn",   name: "HALOS · Sunrise",          vibe: "ambient strings",  bpm: 70,  root: 50, scale: [0,2,4,7,9,11],     prog: [[0,2,4],[2,4,0],[5,0,2],[3,5,0]],         lead: "sine",     pad: "sine",     leadDensity: 0.15, drums: "off",   arp: { type: "sine", density: 0.6, oct: 2 },     color: "#a855f7" },
  { id: "moreme-grind", name: "More Me · Grind",          vibe: "workout drive",    bpm: 132, root: 45, scale: [0,2,3,5,7,8,10],  prog: [[0,2,4],[5,2,4],[3,0,2],[4,1,3]],         lead: "sawtooth", pad: "sawtooth", leadDensity: 0.7,  drums: "hard",                                                      color: "#3edbb5" },
  { id: "brobot-lounge",name: "BroBot · Lounge",          vibe: "chillhop",         bpm: 86,  root: 48, scale: [0,2,3,5,7,9,10],  prog: [[0,4,7],[3,5,0],[5,0,2],[2,4,0]],         lead: "triangle", pad: "triangle", leadDensity: 0.3,  drums: "soft",                                                      color: "#d4af37" },
  { id: "signal-pulse", name: "SignalFinder · Pulse",     vibe: "minimal techno",   bpm: 124, root: 44, scale: [0,2,4,5,7,9,11],  prog: [[0,4,7],[2,5,9],[4,7,11],[5,0,4]],         lead: "square",   pad: "triangle", leadDensity: 0.6,  drums: "hard",  arp: { type: "square", density: 0.8, oct: 1 },    color: "#ff5577" },
  { id: "blueprint-set",name: "Digital Blueprint · Set",  vibe: "ambient piano",    bpm: 64,  root: 53, scale: [0,2,4,7,9,11],     prog: [[0,2,4],[2,4,6],[5,0,2],[3,5,0]],         lead: "triangle", pad: "sine",     leadDensity: 0.2,  drums: "off",   arp: { type: "triangle", density: 0.5, oct: 1 }, color: "#ffb84d" },
  { id: "voss-anthem",  name: "Voss · Anthem",            vibe: "newsroom theme",   bpm: 116, root: 46, scale: [0,2,4,5,7,9,11],  prog: [[0,4,7],[5,7,11],[3,5,0],[4,7,2]],         lead: "sawtooth", pad: "triangle", leadDensity: 0.55, drums: "house", arp: { type: "sawtooth", density: 0.55, oct: 1 }, color: "#d946ef" },
  { id: "starchaser",   name: "Star Chaser",              vibe: "epic build",       bpm: 128, root: 47, scale: [0,2,3,5,7,9,11],  prog: [[0,2,4,6],[4,6,1,3],[5,0,2,4],[3,5,7,2]], lead: "sawtooth", pad: "sawtooth", leadDensity: 0.7,  drums: "tribal", arp: { type: "triangle", density: 0.7, oct: 2 }, color: "#06b6d4" },
];
