...
const SERVICES: Service[] = [
  ...
  { id: "grafana", name: "Grafana", group: "Observability", tokenLabel: "Service-account token", needsBaseUrl: true, console: "https://grafana.com/docs/grafana/latest/administration/service-accounts/", hint: "dashboards + firing alerts" },
  { id: "prometheus", name: "Prometheus", group: "Observability", tokenLabel: "Bearer (optional)", needsBaseUrl: true, hint: "target health + golden-signal queries" },
  { id: "uptimekuma", name: "Uptime Kuma", group: "Observability", tokenLabel: "Metrics API key", needsBaseUrl: true, console: "https://github.com/louislam/uptime-kuma/wiki/Prometheus-Integration", hint: "monitor up/down + response time" },
